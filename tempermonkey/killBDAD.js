...
(function() {
  ...
  function clearAD() {
    ...
    var mAds = document.querySelectorAll('.ec_wise_ad,.ec_youxuan_card,.page-banner'); var i
  ...
  function clearOneAD(ele) {
    // q: element nodetype === 1 what mean?
    // a: https://developer.mozilla.org/en-US/docs/Web/API/Node/nodeType
    // 不是标签的类型 An Element node like <p> or <div>.
